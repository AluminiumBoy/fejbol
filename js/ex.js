...
import { tokens, words, norm, esc, shuffle, shuffleApart, matchSpoken, rhymeGroups, rhymeLine } from './text.js?v=38';
import { lineImages, lineScene, hasHint } from './imagery.js?v=38';
import { hasGloss } from './gloss.js?v=38';
